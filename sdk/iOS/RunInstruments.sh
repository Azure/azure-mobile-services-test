...
# TODO: Copy in correct version of the framework
...
if [ "$DEVICE_CMD_ARG" == "iPadSimResizable" ]; then
  ...
  export DEVICE_ARG=Resizable\ iPad\ \(8.1\ Simulator\)
