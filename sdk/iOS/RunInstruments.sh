...
xcodebuild -sdk iphonesimulator8.2 || exit 1
...
if [ "$DEVICE_CMD_ARG" == "iPadSimResizable" ]; then
  ...
  export DEVICE_ARG=Resizable\ iPad\ \(8.2\ Simulator\)
